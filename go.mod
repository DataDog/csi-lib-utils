...
replace (
	k8s.io/apiextensions-apiserver => k8s.io/apiextensions-apiserver v0.31.0-beta.0
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.31.0-beta.0
	k8s.io/component-base => k8s.io/component-base v0.31.0-beta.0
	k8s.io/component-helpers => k8s.io/component-helpers v0.31.0-beta.0
	k8s.io/kubelet => k8s.io/kubelet v0.31.0-beta.0
)
